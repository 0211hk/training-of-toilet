...
public class ImageType {
    public static final String JPEG = "jpg", BMP = "bmp", GIF = "gif", PNG = "png", TIFF = "tif",
            PICT = "pic", UNKNOWN = "UNKNOWN";
    ...
    public static enum Format {
        ...
        private Format(String s, String contentType) {
            name = s;
    ...
    public static Format getFormat(byte[] b) {
        ...
        if (b.length < 8)
            return Format.UNKNOWN;
        l = (long) b[0] << 56 | ((long) b[1] & 0xffL) << 48 | ((long) b[2] & 0xffL) << 40
                | ((long) b[3] & 0xffL) << 32 | ((long) b[4] & 0xffL) << 24
                | ((long) b[5] & 0xffL) << 16 | ((long) b[6] & 0xffL) << 8 | ((long) b[7] & 0xffL);
        if ((l & jpeg) == jpeg)
            return Format.JPEG;
        else if ((l & png) == png)
            return Format.PNG;
    ...
    //formats
    private static final long jpeg = 0xffd8000000000000L, png = 0x89504E470D0A1A0AL,
            gif = 0x4749460000000000L, tiff1 = 0x4949000000000000L, tiff2 = 0x4D4D000000000000L,
